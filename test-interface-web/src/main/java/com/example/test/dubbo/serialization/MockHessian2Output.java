...
public class MockHessian2Output extends AbstractHessianOutput
     ...
     */
    public MockHessian2Output(OutputStream os) {
        _os = os;
    }
    ...
    */
    ...
    public void writeObject(Object object)
        ...
        if(serializer.getClass().equals(MapSerializer.class)){
    ...
    public OutputStream getBytesOutputStream()
            throws IOException {
        return new MockHessian2Output.BytesOutputStream();
    }
